			...
			*/
			...
			$this->sections[] = array(
				...
				'fields'	=> array(
					...
					array( // Home info Box
						'id'		=> $themePrefix . 'area_title',
						'type'		=> 'title',
						'title'		=> __('Info Home boxes'),
						'subtitle'		=> __('Inform all the each field.')
					),
					// Fisrt part of Home info boxes
					array( // First info box ico
						'id'		=> $themePrefix . 'infoBox_ico_one',
						'type'		=> 'media',
						'title'		=> __('First ico')
					),
					array( // First info box title
						'id'		=> $themePrefix . 'infoBox_title_one',
						'type'		=> 'text',
						'title'		=> __('Title')
					),
					array( // First info box excerpt
						'id'		=> $themePrefix . 'infoBox_excerpt_one',
						'type'		=> 'text',
						'title'		=> __('Excerpt')
					),
					// Second part of Home info boxes
					array( // Second info box ico
						'id'		=> $themePrefix . 'infoBox_ico_two',
						'type'		=> 'media',
						'title'		=> __('Second ico')
					),
					array( // Second info box title
						'id'		=> $themePrefix . 'infoBox_title_two',
						'type'		=> 'text',
						'title'		=> __('Title')
					),
					array( // Second info box excerpt
						'id'		=> $themePrefix . 'infoBox_excerpt_two',
						'type'		=> 'text',
						'title'		=> __('Excerpt')
					),
					// Third part of Home info boxes
					array( // Third info box ico
						'id'		=> $themePrefix . 'infoBox_ico_three',
						'type'		=> 'media',
						'title'		=> __('Third ico')
					),
					array( // Third info box title
						'id'		=> $themePrefix . 'infoBox_title_three',
						'type'		=> 'text',
						'title'		=> __('Title')
					),
					array( // Third info box excerpt
						'id'		=> $themePrefix . 'infoBox_excerpt_three',
						'type'		=> 'text',
						'title'		=> __('Excerpt')
					),
				)
